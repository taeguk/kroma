...
func NewL1Backend() *backends.SimulatedBackend {
	return NewBackendWithGenesisTimestamp(0, true, false)
}
...
func NewL2Backend() *backends.SimulatedBackend {
	return NewBackendWithGenesisTimestamp(0, false, true)
}

func NewBackendWithGenesisTimestamp(ts uint64, shanghai bool, zktrie bool) *backends.SimulatedBackend {
